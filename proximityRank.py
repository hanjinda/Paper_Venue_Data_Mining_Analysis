...
for i in range(numPaper):
    paperUnion.append( citationCount1stOrder[queryIndex] + citationCount1stOrder[i] - W_first[queryIndex][i])

similarity1stOrder = W_first[queryIndex]/paperUnion
...
PaperScores = []
for i in range(numPaper):
    PaperScores.append((similarity2nOrder[i],i))
